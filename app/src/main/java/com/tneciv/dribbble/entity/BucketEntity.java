 ...
 * on 2016-08-15 17:57 .
 */
public class BucketEntity implements Parcelable {
    /**
     * id : 2754
     * name : Great Marks
    ...
    public static final Creator<BucketEntity> CREATOR = new Creator<BucketEntity>() {
        @Override
        public BucketEntity createFromParcel(Parcel in) {
            return new BucketEntity(in);
        }
